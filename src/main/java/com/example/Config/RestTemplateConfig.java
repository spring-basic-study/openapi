...
import com.example.Config.HttpHostsConfiguration.HttpHostConfiguration;
    ...
    public PoolingHttpClientConnectionManager poolingHttpClientConnectionManager() {
        ...
        if (!CollectionUtils.isEmpty(this.httpHostConfiguration.getMaxPerRoutes())) {
            for (HttpHostConfiguration httpHostConfig : this.httpHostConfiguration.getMaxPerRoutes()) 
            {
                ...
                HttpHost host = 
                		new HttpHost(httpHostConfig.getHost(), httpHostConfig.getPort(), httpHostConfig.getScheme());

package step01.util.httpConfig;

import step01.util.searchConfig.SearchProperties;
...
public class RestTemplateConfig {
    ...
    @Bean
    @ConditionalOnMissingBean
    public String getSearchUrl(SearchProperties searchProperties) {
        // TODO: Blog 외 확장(반환 타입 변경)
        // TODO: UriComponentsBuilder 사용(∵ query 받으면 Bean 생성 에러)
        return searchProperties.getBlogUrl() + "?query=";
    }
}
